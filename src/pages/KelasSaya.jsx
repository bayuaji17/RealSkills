  ...
  return (
    <div className="bg-[#EBF3FC] h-screen flex flex-col">
      ...
      <div className=" w-full laptop:flex flex-col flex-wrap justify-center items-center">
        <div>
          <div className="flex items-center justify-between mx-5 pt-0 pb-4 laptop:py-6 laptop:ml-0 laptop:mr-0  text-lg ">
            ...
            <div className="flex  gap-20">
              ...
              <div className="flex flex-col gap-5">
                <div className="flex justify-between w-[94vw]  laptop:gap-14 laptop:w-full ">
                  ...
                  <button className="py-1 pl-7 pr-7 mr-3 rounded-xl bg-white hover:bg-[#6148FF] hover:text-white active:text-white focus:text-white active:bg-[#6148FF] focus:outline-none focus:ring focus:ring-violet-300 focus:bg-[#6148FF] laptop:py-1 laptop:px-20 ">
                    In Progress
                  </button>
                  <button className="py-1 pl-6 pr-6 rounded-xl bg-white hover:bg-[#6148FF] hover:text-white active:text-white focus:text-white active:bg-[#6148FF] focus:outline-none focus:ring focus:ring-violet-300 focus:bg-[#6148FF] laptop:py-1 laptop:px-16">
                    Selesai
                  </button>
                </div>
                <div className="flex flex-wrap w-[13rem] rounded-3xl shadow-md bg-white laptop:w-[19rem]">
