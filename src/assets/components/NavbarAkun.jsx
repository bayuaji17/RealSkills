    ...
    <div className="parents bg-[#6148FF] w-full h-[6.5rem] flex items-center justify-between px-[5rem] py-[2rem] font-poppins">
      ...
      <div className="nav-right-section w-[20%] flex">
        <div className="link-section flex justify-evenly gap-[1rem] w-full">
          <div className="bars-icon-section flex items-center">
            <FontAwesomeIcon
              icon={faBars}
              size="xl"
              style={{ color: "#FFFFFF" }}
          ...
          <div className="user-icon-section flex items-center gap-[0.75rem] px-[2.25rem] py-[.5rem] rounded-[1rem] bg-[#489CFF]">
            <FontAwesomeIcon
              icon={faUser}
              size="xl"
              style={{ color: "#FFFFFF" }}
            />
            <span className="font-semibold text-white leading-[1.5rem] tracking-wide font-montserrat">
              Akun
            </span>
          </div>
        </div>
