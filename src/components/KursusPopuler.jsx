...
export const KursusPopuler = () => {
  return (
    <div className="px-4 py-2 laptop:mx-[6rem]">
      <h1 className="font-semibold text-xl text-md">Kursus Populer</h1>
      <div className=" flex justify-between item-center">
        <div className="flex p-2 font-bold justify-between gap-5 w-full text-sm overflow-x-auto">
{/* <div className="grid grid-cols-7 w-full gap-3 text-md"> */}
       <button className=" py-1 px-3 rounded-2xl bg-[#E8F1FF] hover:bg-[#6148FF] hover:text-white active:bg-[#6148FF] active:text-white focus:text-white focus:outline-none focus:ring focus:ring-violet-300 focus:bg-[#6148FF] laptop:py-1 laptop:px-3 laptop:rounded-2xl">All</button>
        <button className="py-1 px-3 rounded-2xl bg-[#E8F1FF] hover:bg-[#6148FF] hover:text-white active:bg-[#6148FF] active:text-white focus:text-white focus:outline-none focus:ring focus:ring-violet-300 focus:bg-[#6148FF]">Data Science</button>
        <button className="py-1 px-3 rounded-2xl bg-[#E8F1FF] hover:bg-[#6148FF] hover:text-white active:bg-[#6148FF] active:text-white focus:text-white focus:outline-none focus:ring focus:ring-violet-300 focus:bg-[#6148FF]">UI/UX Design</button>
        <button className="py-1 px-3 rounded-2xl bg-[#E8F1FF] hover:bg-[#6148FF] hover:text-white active:bg-[#6148FF] active:text-white focus:text-white focus:outline-none focus:ring focus:ring-violet-300 focus:bg-[#6148FF]">Android Development</button>
        <button className="py-1 px-3 rounded-2xl bg-[#E8F1FF] hover:bg-[#6148FF] hover:text-white active:bg-[#6148FF] active:text-white focus:text-white focus:outline-none focus:ring focus:ring-violet-300 focus:bg-[#6148FF]">Web Development</button>
        <button className="py-1 px-3 rounded-2xl bg-[#E8F1FF] hover:bg-[#6148FF] hover:text-white active:bg-[#6148FF] active:text-white focus:text-white focus:outline-none focus:ring focus:ring-violet-300 focus:bg-[#6148FF]">IOS Development</button>
        <button className="py-1 px-3 rounded-2xl bg-[#E8F1FF] hover:bg-[#6148FF] hover:text-white active:bg-[#6148FF] active:text-white focus:text-white focus:outline-none focus:ring focus:ring-violet-300 focus:bg-[#6148FF]">Business Intelligence</button>
{/* </div> */}
        </div>
      </div>

      <div className="flex flex-wrap w-[19rem]  rounded-3xl shadow-lg">
        <img className="mb-1 w-full h-[5rem]" src={logo} alt="Logo" />
        <div className="px-3 pb-3 w-full">
          <div className="flex justify-between   ">
            <p className="font-bold text-xs text-[#6148FF]">UI/UX Design</p>
        <p className="flex gap-1 text-xs">
            <FontAwesomeIcon icon={faStar} className=" text-[#F9CC00]" />
            4.7
        </p>
          </div>
          <p className="font-bold text-xs py-1 ">Belajar Web Designer dengan Figma</p>
